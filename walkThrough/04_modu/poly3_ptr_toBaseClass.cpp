...
class Polygon {
	...
	public:
		...
		width = a; height = b; }
		virtual int	area() { return (0);} // Asi puede acceder des el PTR de Poly a las funciones miembros de sus herederos
};
...
int main( void ) {
	...
	// Es por lo anterio que aqui  puedeo acceder desde el PTR;
